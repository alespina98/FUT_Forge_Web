...
import { safeHttpUrl, safeLeakImageUrl } from "./core";
...
const leakSelect = `id,slug,title,short_description,content,content_locale,translations,category,confidence,game,status,image_url,normalized_subject,event_key,player_metadata,created_at,published_at,updated_at,first_seen_at,reports:leak_reports(${reportSelect})`;

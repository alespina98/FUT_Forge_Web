...
function LockedInstallCard({ it }: { it: boolean }) {
  return (
    <div className="browser-install-card browser-locked-card">
      ...
      <p>
        {it
          ? "Browser Mode è legato al tuo account FUT Forge. Accedi o registrati per ottenere il preferito."
      ...
      <div className="browser-locked-actions">
        <Link href="/app/register" className="browser-drag-button">
          {it ? "Registrati" : "Sign up"}
        </Link>
        <Link href="/app/login" className="browser-locked-login">
          {it ? "Accedi" : "Log in"}
        </Link>
      </div>
    </div>

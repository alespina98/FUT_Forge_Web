...
const words = {
  en: { nations: "Players by Nation", clubs: "Players by Club", leagues: "Players by League", intro: "Browse indexable EA FC 27 player collections, ordered by player count.", search: "Search directory", players: "players" },
  it: { nations: "Giocatori per Nazione", clubs: "Giocatori per Club", leagues: "Giocatori per Campionato", intro: "Esplora le raccolte indicizzabili di giocatori EA FC 27, ordinate per numero di giocatori.", search: "Cerca nella directory", players: "giocatori" },
};

...
export function Fc27StatFinderView({result,options,initial}:{result:StatFinderResult;options:FilterOptions;initial:Record<string,string>}){
  const {t,locale}=useI18n();const c=t.fc27StatFinderPage;const returnTo=useFc27ReturnPath();const outfieldLabels=["PAC","SHO","PAS","DRI","DEF","PHY"];const goalkeeperLabels=["DIV","HAN","KIC","REF","SPD","POS"];
